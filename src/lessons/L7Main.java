...
public class L7Main {
    ...
    public static void main(String[] args) {
        ...
        for (AbstractShape shape : shapes) {
            if (shape.getPerimetr() > biggestPerimShape.getPerimetr()) {
        ...
        if (biggestPerimShape instanceof Circle) {
            System.out.println("Biggest Perimetr has Circle: " + biggestPerimShape.getPerimetr());
        }
        if (biggestPerimShape instanceof Square) {
            //biggestPerimShape.printFromSquare();
            System.out.println("Biggest Perimetr has Square: " + biggestPerimShape.getPerimetr());
            Square squareShape = (Square) biggestPerimShape;
            squareShape.printFromSquare();
        }
        if (biggestPerimShape instanceof EqSideTriangle) {
            System.out.println("Biggest Perimetr has Triangle: " + biggestPerimShape.getPerimetr());
        }
