...
public class L2Main {
    public static void main(String... args) {
        ...
        // [0, 10)
        int zeroTen = getRandomFromRange(0, 10);
        // [2, 10)
        int twoTen = getRandomFromRange(2, 10);
        // [10, 80)
        int gg = getRandomFromRange(10, 80);
        int random = getRandomFromRange(498, 500);
        random = getRandomFromRange(800, 1600);
        ...
        int num1 = getRandomFromRange(1, 10);
        int num2 = getRandomFromRange(1, 10);

        int closest = getClosestTo100(getRandomFromRange(1, 10), getRandomFromRange(1, 10));
        ...
        checkRange(getRandomFromRange(5, 25));
    }
