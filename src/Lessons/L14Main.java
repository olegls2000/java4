...
import static Lessons.ReflectionUtils.callSecretMethod;
import static Lessons.ReflectionUtils.getDefaultConstructor;
...
public class L14Main {
        ...
        public static void main(String[] args) throws Exception {
            ...
            List<Circle> circles = generateCircles(2);
            List<Human> humans = generateHuman(2);



            List<Object> objects = generateObjects(2, Circle.class);
